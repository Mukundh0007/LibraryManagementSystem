     ...
     def admin():
          ...
          def newroot():
               ...
               def adminreg():
                    ...
                    ans=simpledialog.askstring('Input','Enter school code',parent=root2)
                    if ans==school_code:
                         def submitad():
                              global cur,con
                              adnom=adno.get()
                         ...
                         Label(root2,text='Name:',bg='#39322C',fg='white').place(x=540,y=200)
                         lastname=frstname=Entry(root2,width=30,textvariable=lastvalue).place(x=650,y=200)

                         Label(root2,text='Adno:',bg='#39322C',fg='white').place(x=540,y=250)
                         lastname=frstname=Entry(root2,width=30,textvariable=adno).place(x=650,y=250)
                         ...
                         submit=Button(root2,image=sub,bg='black',height=50,width=175,command=submitad)
...
#===============================================================================================
##                    else:                                                                     |
##                         mbox.showinfo('Wrong code','Enter the right code')                   |
##==============================================================================================                      
               value=StringVar()
               value2=StringVar()
               ...
               def studregister():
                    ...
                    def submitstud():
                         ...
                         if pwd!=conpwd:
                              ...
                              st='insert into studetail values({},"{}","{}","{}","{}","{}")'.format(idstud,nam,dob,classec,uname,pwd)
                              cur.execute(st)
                              con.commit()
                    value=StringVar()
                    lastvalue=StringVar()
                    ...
                    bg=PhotoImage(file='zenregis.png')
                    Label(root2,image=bg).place(relwidth=1,relheight=1)
                    mbox.showinfo('Reminder','''Kindly enter date in YYYY-MM-DD format''')
               ...
               signinbtn=Button(root,image=signin,bg='black',height=25,width=175,command=adminreg)
